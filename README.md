...
El dataset completo con sentimiento predicho está disponible en los [**Releases del repositorio**](https://github.com/Fede1992/Tesis-ORT-Bendetti---La-Laina/releases/tag/v1.0):
